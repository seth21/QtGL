...
void main()
{ 
    vec2 screenTexSize = textureSize(gPosition, 0);
    vec2 noiseTexSize = textureSize(noiseTexture, 0);
    vec2 noiseScale = screenTexSize / noiseTexSize;
    ...
    for(int i = 0; i < kernelSize; ++i)
    {
        ...
        // get sample depth
        float sampleDepth = (view * vec4(texture(gPosition, offset.xy).xyz,1)).z; // get depth value of kernel sample
