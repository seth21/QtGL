...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Scene3D_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Scene3D_t qt_meta_stringdata_Scene3D = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Scene3D"
...
QT_INIT_METAOBJECT const QMetaObject Scene3D::staticMetaObject = { {
    QMetaObject::SuperData::link<QGLWidget::staticMetaObject>(),
    qt_meta_stringdata_Scene3D.data,
    qt_meta_data_Scene3D,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Scene3D::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Scene3D.stringdata0))
